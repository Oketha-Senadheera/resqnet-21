...
<main class="content" id="mainContent" tabindex="-1">
        <section class="section" aria-label="Safe Locations">
          <div class="section-head">
            ...
            <a href="C:\Users\oketh\IdeaProjects\resqnet\src\main\webapp\WEB-INF\views\dmc\demo\add-safe-locations.jsp" class="btn btn-primary" id="addSafeLocationBtn">Add Safe Location</a>
          </div>
          <div class="safe-grid">
