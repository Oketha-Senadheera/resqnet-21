...
<%
    ...
    String username = authUser != null ? authUser.getUsername() : "NGO";
%>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="layout">
      ...
      <aside class="sidebar" aria-label="Primary">
        ...
        <div class="sidebar-footer">
          <button class="logout" aria-label="Logout" onclick="window.location.href='${pageContext.request.contextPath}/logout'">↩ Logout</button>
        </div>
      </aside>
